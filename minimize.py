...
def minimize(fun, x0, args=(), method=None, jac=None, hess=None,
             ...
             callback=None, options=None, shape=None, lamcts_boundry=None, restart_options=None, ac_func=None, problem=None, ub=None,
             lb=None):
    ...
    **Custom minimizers**
    ...
    if meth == 'nelder-mead':
        ...
        return _minimize_lbfgsb(fun, x0, args, jac, bounds,
                                callback=callback, shape=shape, lamcts_boundry=lamcts_boundry, ac_func=ac_func, restart_options=restart_options,
                                problem=problem, ub=ub, lb=lb, **options)
    elif meth == 'tnc':
